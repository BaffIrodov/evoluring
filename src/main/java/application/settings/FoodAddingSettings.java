...
public class FoodAddingSettings {
    public int freeFoodAddingRate = 65; // в тик на карте появляются столько квадратов free-еды
    public int closeFoodAddingRate = 65; // в тик на карте появляются столько квадратов close-еды
